      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          {[
            ...
            { label: 'En cours',             value: processing.length,     icon: <ClipboardList size={18}/>, color: 'text-primary',    bg: 'bg-primary/10',    clickable: false },
                  ...
                  {processing.map(r => (
                    <Link key={r.id} to={`/agent/process/${r.id}`}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-primary truncate">Attribuée · Cliquez pour traiter</p>
                      </div>
